...
project = 'GMCoinBot'
copyright = '2018, GeekMasher'
author = 'GeekMasher'

# The full version, including alpha/beta/rc tags
try:
    release = pkg_resources.get_distribution('gmcoinbot').version
except pkg_resources.DistributionNotFound:
    print('GMCoinBot must be installed to build the documentation.')
    sys.exit(1)
...
htmlhelp_basename = 'GMCoinBotdoc'
...
latex_documents = [
    (master_doc, 'GMCoinBot.tex', 'GMCoinBot Documentation',
     'GeekMasher', 'manual'),
]
...
man_pages = [
    (master_doc, 'gmcoinbot', 'GMCoinBot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GMCoinBot', 'GMCoinBot Documentation',
     author, 'GMCoinBot', 'One line description of project.',
     'Miscellaneous'),
]

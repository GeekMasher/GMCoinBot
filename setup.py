...
ABOUT = read(join(__SRC__, 'gmcoinbot', '__version__.py'))
...
setup(
    ...
    url=ABOUT['__url__'],
    project_urls = {
        'Source Code': 'https://github.com/GeekMasher/GMCoinBot',
        'Bug Tracker': 'https://github.com/GeekMasher/GMCoinBot/issues'
    },
